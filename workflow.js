...
window.GG_WORKFLOW = {
  ...
  steps: [
    ...
    { t: "10:50 AM", lane: "human", actor: "Lauren · Roshan · Matt", act: "Locked the idea (for now): restaurant pop-up", detail: "On air: 'pop-up OS for restaurants' — a real SF pop-up with a partnering chef, ticketed as an experiential dinner, ops software as the meta product. First deliverable of the day.", day: 1, deliverable: "idea" },
    ...
    { t: "11:25 AM", lane: "human", actor: "Matt", act: "Absorbed Codie Sanchez's distribution doctrine", detail: "On air: sell to three people first; distribution is the moat; controversy marketing (2.4M and 5.7M-view examples); keep a proof vault; oversee bots intensely.", day: 1 },
    ...
    { t: "4:19 PM",  lane: "ai", actor: "Tee Bot · Pixel", act: "Designed pop-up supplies and merch", detail: "On screen: ticket stubs with tier badges, lanyards, and plush concepts — the plush line iterated 'against the official art.'", day: 1, deliverable: "tickets" },
    { t: "4:20 PM",  lane: "ai", actor: "dr. eggbot", act: "Stood up the lander", detail: "On air: the domain live on Vercel wired to PlanetScale — 'the domain is live… I hooked it up to our database' — with viewers told 'don't submit yet… throwaway prototype.' The URL (shipbythursday.day) was spoken on air.", day: 1, deliverable: "lander" },
