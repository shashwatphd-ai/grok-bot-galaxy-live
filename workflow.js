...
window.GG_WORKFLOW = {
  ...
  steps: [
    ...
    /* ── Day 2 — Wed Sep 16: the pivot to the game studio ── */
    ...
    { t: "9:39 AM",  lane: "ai", actor: "Knowledge Base bot", act: "Documented the pivot in Notion", detail: "'Our knowledge base bot… started working on updating our Notion with our company doc. So now we're working on our game design studio… we're documenting the pivot and eventually what our go-to-market strategy might be.' The screen later read: 'There is no pop-up' — Oct 15 venue/host/dining tracks retired.", day: 2, deliverable: "pivot-doc" },
  ...
  deliverables: [
    ...
    /* ── Day 2 ── */
    { id: "pivot-doc", t: "9:39 AM", name: "Company doc rewritten: the pivot documented", status: "SHIPPED", detail: "'Now we're working on our game design studio… we're documenting the pivot.' The pop-up tracks retired in Notion.", day: 2 },
    ...
    { id: "cupcake-proto", t: "9:50 AM", name: "The game ('Cupcake', working name)", status: "BUILD", detail: "Marketplace-bot draft battler: no login, no DB, debug sliders; first played 10:03; by close X login + leaderboard wired and one bug blocking matches.", day: 2 },
