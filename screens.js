...
window.GG_SCREENS = [
  ...
  { id: "d2-se-usecases", file: "screens/d2-whiteboard.png", t: "00:40:00 (Day 2 replay)", wall: "9:17 AM", day: 2, title: "Sales Engineer use cases: four quadrants", caption: "The SE session's use-case slide: Engineer (technical resource), Customer Expert (Gong/Salesbricks checks), Echo (live deck nudges during calls), and Competitive Intel (battlecards kept current by a bot).", kind: "session" },
  { id: "d2-vision-deck", file: "screens/d2-vision-deck.png", t: "00:59:00 (Day 2 replay)", wall: "9:32 AM", day: 2, title: "Building the Vision Deck live", caption: "Amrita's 'SpaceXAI Vision Deck' in Google Slides — the 'Why SpaceXAI?' narrative slide assembled and delivered in the same session.", kind: "session" }
];
