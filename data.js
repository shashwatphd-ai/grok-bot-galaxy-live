...
window.GG_MOMENT = "Day 2: the Pop-up OS product kept building toward Thursday while 'Cupcake' (code name) — a side demo of agent prototyping speed — became the day's showpiece.";
...
window.GG_ENTRIES = [
  ...
  },
  {
    ...
    body: "The broadcast title changed to 'Grok Bot builds a Game Studio LIVE' — the game-studio framing became the stream's public identity for the day ('we're a game studio building a game along a three-day journey,' on air). The product line underneath — the ops software heading for Thursday — never left the plan doc.",
    delta: [
  ...
  },
  {
    ...
    body: "The knowledge-base bot updated the company doc in Notion, and Matt narrated it: 'we also have our knowledge base bot that started working on updating our Notion with our company doc. So now we're working on our game design studio. We still have some objectives, but we're documenting the pivot and eventually like what our go-to-market strategy might be.' Two minutes later: 'If you're just joining in, we're working on our game studio and our first game.' And at 9:42: 'You're watching us spend 72 hours building a game studio and a game for the game studio.' What the Notion screen retired was the October pop-up event — 'There is no pop-up. Oct 15 venue / host / dining tracks are retired' — while the ops-software product line continued toward Thursday's ship. The go-to-market roadmap, on air: landing page → AEO/SEO → A/B testing → lean into existing distribution → ads infrastructure.",
    delta: [
  ...
  },
  {
    ...
    body: "The agent org: Steve is the chief of staff holding the project context and routing work to the other bots; Lauren instructed dr. eggbot to 'create an engineering bot… use P-Stack and Potato Mode to spawn cloud agents to work on our game… orchestrate these cloud agents and supervise them and check their work.' A founding-engineer bot (preview deploys) and a growth-engineer bot were active. The creative-director bot was set on game visuals — 'I'm a total noob to video games… do research on how these things work' — and produced a slider-tunable SVG asset playground (flat design tokens, run locally).",
    lenses: {
  ...
  },
  {
    ...
    body: "Matt, pointing his agent at Lauren's planning doc: 'Hey, take a look at that document. That's going to be our game. Our first goal is to make a landing page.' Minutes later the lander scaffold was building ('we have our lander getting spun up'), with the discipline stated as subtraction: 'removing auth, removing a waitlist. We literally just want like a V1.'",
    lenses: {
  ...
  },
  {
    ...
    body: "The SE session's use-case slide: Engineer (a technical resource drafted in seconds); Customer Expert (knows the product inside out — Codebricks, PlayerScale — flags unusual usage and power users); Echo (updates the deck live during calls, Granola/Gong follow-up); Competitive Intel (uses competitors' products and keeps battlecards current). About 49.7K views around this point.",
    lenses: {
  ...
  },
  {
    ...
    body: "The final guest segment: Jenny, a VC and creator (Gemma Media), walked her 22-bot event-production suite — a venue-scouting bot, a permit bot, a production-budget bot, and invite-list sourcing. Her producer's advice materially reshaped the trio's pop-up plan in the last hour of the day.",
    quote: {
  ...
  },
  {
    ...
    body: "The founders session showed a bot-prepared call brief — 'Northwind Labs - call prep' with attendee bios, a numbered summary of account history, an unanswered pricing question, and agenda gates — on a fake note-taking app (Northwind is hypothetical, with Notion and Craft named as pretend competitors). The takeaway: bots can walk into a sales call with the full account story.",
    lenses: {
  ...
  },
  {
    ...
    body: "Feature grid, from the slide: Easy as iMessage (bots DM you approvals and status); Always-on 24/7; Uses your tools like you (bots drive real SaaS with your logins); Finishes the work (create → direct → automate); and Shareable Templates — 'Peng shared Kenny with you,' a ready-made operations bot.",
    lenses: {
  ...
  },
  {
    ...
    body: "On screen, a 'Tee Bot' thread ran the merch channel: promo email drafts with best-seller banners woven in, generic roundup formats deliberately avoided, and a side panel of copy variants. The merch bot's name on air: 'drop.'",
    lenses: {
  ...
  },
  {
    ...
    lenses: {
      ...
      skeptic: "Sample data, again — the stream never badged it."
    }
  },
  {
    id: "d1-1407",
  ...
  },
  {
    ...
    body: "Through agent dialogue (a 'platform for creators', small-business angles, pop-up concepts), the trio landed on: 'pop-up OS for restaurants' — run a real pop-up in San Francisco with a partnering chef, ticket it as an experiential dinner, and build the operating software: 'build an OS for running pop-ups, this meta product.' The company behind it got its name the same hour: Ship by Thursday. (This direction itself kept moving after lunch — see 3:25 PM.)",
    delta: [
  ...
  },
  {
    ...
    body: "The 101 hour (Roman and Amrita on stage) walked product surfaces: creating your first bot through onboarding categories; a bot Marketplace with community creators' bots and Install buttons (community creators named on air: Lenny, Clairvaux, Eric-from-Cursor); and an email demo — a coffee-survey summary sent on the bot's own initiative, while the screen showed a supplier shipment confirmation and a logistics memo draft.",
    lenses: {
  ...
  },
  {
    ...
    body: "First guest of the day: Peter Yang, ex-Instagram PM and creator — 'anyone can build anything now, but… it's hard to make money from pure software… people pay for the hard stuff.' His framing — value shifting from the app to distribution and physical-world execution — sat under every idea the trio chose for the rest of the day.",
    lenses: {
