...
window.GG_META = {
  ...
  session: "Intermission — Be right back",
  viewers: "191.3K",
  onAir: "5h 25m",
  updated: "1:52 PM PT",
...
window.GG_PRIMER = {
  ...
  sofar: "Day 2 morning: the company pivoted to a game design studio building 'Cupcake Loop' — a competitive character-draft game — and the morning was spent prototyping it potato-mode: a playable localhost prototype with debug sliders, ELO matchmaking design, and 'shorten the time to fun' as the north-star. The Sales Engineering session (Amrita, a Cursor field engineer) demoed her own daily bots — Mimi (case-study slides), Sherlock (repo technical expert), Serena Williams (competitive intel, testing Southwest/Spirit booking flows) — on SpaceX's demo booking app Flylo. The SE whiteboard produced the demo arc now driving the prototype.",
  watchfor: "Sales session at 12:30 PM PT, SDRs at 2:30, Customer Support at 4:00. Watch for: Cupcake Loop gameplay polish and first playable matches, whether 'ship by Thursday' holds for the lander, and how the sales sessions shape go-to-market for the game."
};
...
window.GG_ENTRIES = [
  ...
  },
  {
    ...
    body: "The stream shows a localhost dev server running 'Cupcake Loop': a colorful character-draft game with a pool of stat-card characters (Dr. Rocket, Firebrand, Trajectory, Probability of Rain, Tornado Whisperer, Earthshatter…), difficulty sliders, draft lanes, and a chat box tuning the visuals ('the shimmers are too severe?'). It maps to the SE session's whiteboard arc — 'Draft your team → Set your lineup → Compete!' — now existing as a playable prototype. On tape, the trio later confirmed this IS the new company: a game studio, and Cupcake Loop is its first game. Views: 85.2K.",
    lenses: {
